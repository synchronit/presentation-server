...
<!-- TODO: refactor CSS display and JS functions for the different buttons, to be rendered by Angular in this template -->
		<nav class="nav newFormToolBar">		
			...
			<span ng-if="!onLinkForms"><a id="runButton" ng-href="{{hash}}" class="icon-play"   ng-click="createNewForm();"   style="font-size: 2em;" title="RUN: creates the Form with the defined data"></a></span>
