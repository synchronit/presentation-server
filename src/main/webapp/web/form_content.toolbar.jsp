...
<!-- <div class="toolBar"> -->
		<nav class="nav">
			...
			<span><a style="font-size: 2em;" ng-href="{{hash}}" class="icon-update"></a></span>
			<span><a style="font-size: 2em;" ng-href="{{hash}}" class="icon-delete"></a></span>
			<span><a style="font-size: 2em;" ng-href="{{hash}}" class="icon-clear"  ng-click="clearForm();" title="Clear screen values"></a></span>
		</nav>
<!-- </div> -->
